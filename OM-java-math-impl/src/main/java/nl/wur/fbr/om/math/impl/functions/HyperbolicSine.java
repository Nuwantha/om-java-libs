...
/**
 * This is an implementation of the hyperbolic sine function.
 *
...
public class HyperbolicSine implements Function{
    ...
    /**
     * Tries to evaluate the function given the specified parameters, i.e. calculate the hyperbolic sine of the parameter.
        ...
        if(parameters.length==1){
            ...
            if(!value.hasFunction()){
                if(value.getMeasure()!=null){
                    ...
                    throw new MathException("Cannot calculate the hyperbolic sine of "+value.getQuantity()+".");
                }
            } else newExpression =  new ExpressionImpl(this,value);
            return newExpression;
        }
        throw new MathException("The number of parameters for the hyperbolic sine function is not equal to 1. (N="+parameters.length+")");
    }
     ...
     * The hyperbolic sine always returns a dimensionless value.
     *
