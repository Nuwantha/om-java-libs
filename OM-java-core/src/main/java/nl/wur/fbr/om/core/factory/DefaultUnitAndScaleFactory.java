...
public class DefaultUnitAndScaleFactory implements UnitAndScaleFactory{
    ...
    public BaseUnit createBaseUnit(Dimension dimension) {
        BaseUnit unit = new BaseUnitImpl(dimension);
    ...
    public BaseUnit createBaseUnit(String name, String symbol,Dimension dimension) {
        BaseUnit unit = new BaseUnitImpl(name,symbol,dimension);
        unitsOrScalesByID.put(unit.getIdentifier(),unit);
        return unit;
    }
    ...
    public BaseUnit createBaseUnit(String identifier, String name, String symbol,Dimension dimension) {
        BaseUnit unit = new BaseUnitImpl(identifier,name,symbol,dimension);
        unitsOrScalesByID.put(unit.getIdentifier(),unit);
        return unit;
    }
