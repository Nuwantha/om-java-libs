 ...
 *                  {@link #createBaseUnit(Dimension)}<br>
 *                  {@link #createBaseUnit(String, String, Dimension)} (String, String, String)}<br>
 *                  {@link #createBaseUnit(String, String, String, Dimension)}</td></tr>
...
public class DefaultUnitAndScaleFactory implements UnitAndScaleFactory{
     ...
     * {@link #createPrefixedBaseUnit(Dimension, SingularUnit, Prefix)}.
     ...
     * @param dimension The dimension in which this unit is defined.
     * @return The requested singular base unit.
     */
    @Override
    public BaseUnit createBaseUnit(Dimension dimension) {
    ...
    /**
     * Creates a new singular base unit.For prefixed base units (e.g. kilogram) see
     * {@link #createPrefixedBaseUnit(String,String,Dimension, SingularUnit, Prefix)}.
     * For instance the metre unit is a base unit in SI and does not have a definition unit.
     * The identifier for the unit should be generated by the factory and should be unique.
     *
     ...
     */
    @Override
    public BaseUnit createBaseUnit(String name, String symbol,Dimension dimension) {
    ...
    /**
     * Creates a new singular base unit.For prefixed base units (e.g. kilogram) see
     * {@link #createPrefixedBaseUnit(String,String,String,Dimension, SingularUnit, Prefix)}.
     * For instance the metre unit is a base unit in SI and does not have a definition unit.
     *
     ...
     */
    @Override
    public BaseUnit createBaseUnit(String identifier, String name, String symbol,Dimension dimension) {
     ...
     * prefix (e.g. kilo). For non-prefixed base units see {@link #createBaseUnit(Dimension)}.
     *
     * @param dimension    The dimension in which this unit is defined. (see {@link Dimension})
     * @param singularUnit The Unit that is prefixed.
     * @param prefix       The prefix used for the unit.
     * @return The requested singular base unit.
     */
    @Override
    public BaseUnit createPrefixedBaseUnit(Dimension dimension, SingularUnit singularUnit, Prefix prefix) {
    ...
    /**
     * Creates a new prefixed base unit (e.g. kilogram) that has a unit (e.g. gram) and a
     * prefix (e.g. kilo). For non-prefixed base units see {@link #createBaseUnit(String, String, Dimension)}.
     *
     * @param name         The preferred name of the unit.
     * @param symbol       The symbol used for the unit.
     * @param dimension    The dimension in which this unit is defined. (see {@link Dimension})
     ...
     */
    @Override
    public BaseUnit createPrefixedBaseUnit(String name, String symbol, Dimension dimension, SingularUnit singularUnit, Prefix prefix) {
    ...
    /**
     * Creates a new prefixed base unit (e.g. kilogram) that has a unit (e.g. gram) and a
     * prefix (e.g. kilo). For non-prefixed base units see {@link #createBaseUnit(String, String, String, Dimension)}.
     *
     * @param identifier   A unique identifier for the unit.
     * @param name         The preferred name of the unit.
     * @param symbol       The symbol used for the unit.
     ...
     */
    @Override
    public BaseUnit createPrefixedBaseUnit(String identifier, String name, String symbol, Dimension dimension, SingularUnit singularUnit, Prefix prefix) {
