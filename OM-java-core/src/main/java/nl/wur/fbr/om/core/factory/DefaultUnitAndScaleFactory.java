...
public class DefaultUnitAndScaleFactory implements UnitAndScaleFactory{
    ...
    /**
     * Returns a unit with the specified identifier.
     * If the Unit with the same identifier has been created previously, this method returns the
     * same instance. If the Unit has not been created previously, null is returned as
     * in the <code>DefaultUnitAndScaleFactory</code>, no data is available to for unit conversion. To create a
     * unit, use one of the <code>create*Unit</code> methods.
     *
