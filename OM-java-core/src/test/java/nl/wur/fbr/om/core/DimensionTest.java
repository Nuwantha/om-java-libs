...
public class DimensionTest {
    ...
    public void testCompoundUnitDimension(){UnitAndScaleFactory factory = new DefaultUnitAndScaleFactory();
        ...
        Assert.assertEquals("Compound unit dimension test",1,metreMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        ...
        Assert.assertEquals("Compound unit dimension test", 1, secondMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",1,metrePerSecondSquaredMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        Assert.assertEquals("Compound unit dimension test",-2,metrePerSecondSquaredMap.getDimensionalExponent(SIBaseDimension.TIME));
        Dimension gramMap = gram.getUnitDimension();
        Assert.assertEquals("Compound unit dimension test",1,gramMap.getDimensions().size());
        Assert.assertEquals("Compound unit dimension test",1,gramMap.getDimensionalExponent(SIBaseDimension.MASS));
        ...
        Assert.assertEquals("Compound unit dimension test",1,kilogramMap.getDimensionalExponent(SIBaseDimension.MASS));
        ...
        Assert.assertEquals("Compound unit dimension test",1,newtonMap.getDimensionalExponent(SIBaseDimension.MASS));
        Assert.assertEquals("Compound unit dimension test",1,newtonMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        Assert.assertEquals("Compound unit dimension test",-2,newtonMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",1,newtonMetreMap.getDimensionalExponent(SIBaseDimension.MASS));
        Assert.assertEquals("Compound unit dimension test",2,newtonMetreMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        Assert.assertEquals("Compound unit dimension test",-2,newtonMetreMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",1,pascalMap.getDimensionalExponent(SIBaseDimension.MASS));
        Assert.assertEquals("Compound unit dimension test",2,pascalMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        Assert.assertEquals("Compound unit dimension test",-2,pascalMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",1, millisecondMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",2, millisecondSquaredMap.getDimensionalExponent(SIBaseDimension.TIME));
        ...
        Assert.assertEquals("Compound unit dimension test",1,pascalPerMillisecondSquaredMap.getDimensionalExponent(SIBaseDimension.MASS));
        Assert.assertEquals("Compound unit dimension test",2,pascalPerMillisecondSquaredMap.getDimensionalExponent(SIBaseDimension.LENGTH));
        Assert.assertEquals("Compound unit dimension test",-4,pascalPerMillisecondSquaredMap.getDimensionalExponent(SIBaseDimension.TIME));
    }
}
