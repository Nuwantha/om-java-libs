...
public class Area extends AbstractQuantity {
    ...
    /**
     * Creates an Area quantity without a measure, i.e. this quantity is a variable.
    ...
    /**
     * Creates an Area quantity without a measure as value, i.e. this quantity is variable.
     * An identifier will be automatically generated.
     *
     * @param name    The name of the quantity.
     * @param symbol  The symbol used for the quantity.
     */
    public Area(String name, String symbol) {
        super(name, symbol);
    }
