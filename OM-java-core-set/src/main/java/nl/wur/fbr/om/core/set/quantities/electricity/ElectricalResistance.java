...
/**
 * Instances of this class represent an Electrical Resistance quantity.
 *
...
public class ElectricalResistance extends AbstractQuantity {
     ...
     *                                   dimension of the unit of the measure.
     */
    public ElectricalResistance(String name, String symbol, Measure measure) throws QuantityCreationException {
    ...
    public QuantityClass getQuantityClass() {
        return CoreQuantitySet.ELECTRICAL_RESISTANCE;
    }
}
