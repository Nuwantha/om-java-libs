...
/**
 * Instances of this class represent a time quantity.
 *
...
public class Time extends AbstractQuantity {
     ...
     * @param measure The value of the quantity.
     */
    public Time(String name, String symbol, Measure measure) {
