...
/**
 * Instances of this class represent an Velocity quantity.
 *
...
public class Velocity extends AbstractQuantity {
     ...
     *                                   dimension of the unit of the measure.
     */
    public Velocity(String name, String symbol, Measure measure) throws QuantityCreationException {
    ...
    public QuantityClass getQuantityClass() {
        return CoreQuantitySet.VELOCITY;
    }
}
