...
public class ElectricalPotential extends AbstractQuantity {
    ...
    /**
     * Creates an Electrical Potential quantity without a measure, i.e. this quantity is a variable.
    ...
    /**
     * Creates an Electrical Potential quantity without a measure as value, i.e. this quantity is variable.
     * An identifier will be automatically generated.
     *
     * @param name    The name of the quantity.
     * @param symbol  The symbol used for the quantity.
     */
    public ElectricalPotential(String name, String symbol) {
        super(name, symbol);
    }
