...
/**
 * Instances of this class represent a Radioactivity quantity.
...
public class Radioactivity extends AbstractQuantity{
     ...
     *                                   dimension of the unit of the measure.
     */
    public Radioactivity(String name, String symbol, Measure measure) throws QuantityCreationException {
    ...
    public QuantityClass getQuantityClass() {
        return CoreQuantitySet.RADIOACTIVITY;
    }
}
