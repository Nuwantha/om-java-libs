...
/**
 * Instances of this class represent a Frequency quantity.
 *
...
public class Frequency extends AbstractQuantity {
     ...
     *                                   dimension of the unit of the measure.
     */
    public Frequency(String name, String symbol, Measure measure) throws QuantityCreationException {
    ...
    public QuantityClass getQuantityClass() {
        return CoreQuantitySet.FREQUENCY;
    }
}
