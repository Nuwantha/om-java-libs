...
public interface UnitAndScaleFactory {
     ...
     * @return The unit multiple.
     */
    public UnitMultiple createUnitMultiple(String name, SingularUnit unit, Prefix prefix);
    ...
    /**
     * Creates a new Unit multiple. A Unit multiple (or prefixed unit) has a unit and a factor which is
     * defined by its prefix or by a custom factor. The prefix, kilo, for example has a factor of 1000 and the prefix milli, has a
     * factor of 0.001. For custom units like 125 g, the factor will be 125 and the unit g.
     * This method should be used for non-predefined prefixes. For predefined prefixes use:
    ...
    /**
     * Creates a new Unit multiple. A Unit multiple (or prefixed unit) has a unit and a factor which is
     * defined by its prefix or by a custom factor. The prefix, kilo, for example has a prefix factor of 1000 and the prefix milli, has a
     * prefix factor of 0.001. For custom units like 125 g, the factor will be 125 and the unit g.
     * This method should be used for non-predefined prefixes. For predefined prefixes use:
     * {@link #createUnitMultiple(SingularUnit, Prefix) createUnitMultiple(SingularUnit,Prefix)}.
     *
     * The identifier for the unit should be generated by the factory and should be unique.
